  ...
  const renderUserInfo = () => {
    return (
      <div className='flex flex-col w-80'>
        ...
        <button className='border border-black rounded-lg mt-6 py-3' onClick={()=> setView('edit-user-info')}>Edit</button>
      </div>
    );
  };
    ...
    return (
      <form ref={form} className='flex flex-col gap-4 w-80'>
        <div className='flex flex-col gap-1'>
          ...
          <input type="text" id='name' name='name' defaultValue={account?.name} placeholder='Joao' className='rounded-lg border border-black placeholder:font-light placeholder:text-sm placeholder:text-black/60 focus:outline-none py-2 px-4' />
        </div>
        <div className='flex flex-col gap-1'>
        ...
        <button className='bg-black text-white w-full rounded-lg py-3' onClick={()=> {setView('user-info', editAccount());}}>Edit</button>
      </form>
    );
  };
